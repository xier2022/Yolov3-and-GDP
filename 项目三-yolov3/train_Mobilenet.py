...
def _main():
    ...
    log_dir = settings.LOGS_DIR#'logs/faceMobilenet/001_Mobilenet_finetune/'
    classes_path =settings.DEFAULT_CLASSES_PATH #'model_data/face_classes.txt'
    anchors_path =settings.DEFAULT_ANCHORS_PATH #'model_data/yolo_anchors.txt'
    class_names = get_classes(classes_path)
    num_classes = len(class_names)
    anchors = get_anchors(anchors_path)

    input_shape = settings.MODEL_IMAGE_SIZE#(320, 320)  # multiple of 32, hw
    ...
    if is_tiny_version:
        ...
        model = create_model(input_shape, anchors, num_classes, load_pretrained=False,
                             weights_path=settings.FROZEN_TRAIN_OUTPUT_WEIGHTS,#'logs/faceMobilenet/000_Mobilenet_finetune/trained_weights_final.h5',
    ...
    if True:
        ...
        model.save_weights(log_dir + 'face_detect_model_1.h5')
    ...
    if True:
        ...
        model.save_weights(log_dir + 'face_detect_model.h5')
